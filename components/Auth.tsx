  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (authMode === 'LOGIN') {
      ...
      if (user && user.password === password) {
        ...
        // --- 5. Success ---
        // If Just Approved, maybe show a welcome, but typically we just log them in.
        // If status is Approved or undefined (legacy), let them in.
        login(user);
        onLogin(user);
        ...
        <div className="hidden md:flex flex-col justify-between p-12 bg-neutral-900/60 relative">
           ...
           <div className="relative z-10">
             ...
             <button
                ...
                className="mt-8 inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-black/40 text-xs font-mono text-neutral-400 hover:text-white hover:bg-white/10 hover:border-white/30 transition-all cursor-pointer backdrop-blur-md"
             >
